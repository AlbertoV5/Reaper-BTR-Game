...
local function FinalScore() --FINAL SCORE SCREEN
	...
	if gfx.getchar() == 32 then
		reaper.atexit(FinalScore) --Clean up
		return
	end
...
--PROCESS
BTR.SetGameVariables(hitbox_pre,hitbox_pos,midiScale)
...
--INITIALIZE MAP
beatMap = {}
if randomMap == true then beatMap = BTR.RandomMap(SONG_DURATION_BEATS+1) end
